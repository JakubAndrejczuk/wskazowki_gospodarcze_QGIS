...
class WskazowkiGospodarczeAlg(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        # 11. Dodaj TWP,TPP  (kopiujemy także 'wyk' oraz 'czyn_wyk')
        alg_params = {
            'DISCARD_NONMATCHING': False,
            'FIELD': 'adr_les',
            'FIELDS_TO_COPY': ['gr_czyn', 'pow_man', 'czyn_wyk', 'wyk'],
            'FIELD_2': 'adr_les',
        ...
        # 14. Dodaj pow_man do zreb  (kopiujemy także 'wyk' oraz 'czyn_wyk')
        alg_params = {
            'DISCARD_NONMATCHING': False,
            'FIELD': 'adreso_dz',
            'FIELDS_TO_COPY': ['pow_man', 'czyn_wyk', 'wyk', ],
            'FIELD_2': 'adreso_dz',
        ...
        # 17. Zmień pola formularza zreb_wsk -> Zreb_wsk (DODANO 'wyk' i 'czyn_wyk')
        ...
        alg_params = {
            'FIELDS_MAPPING': [
                ...
                {'alias': '','comment': '','expression': '"pow_man"','length': 10,'name': 'pow_man','precision': 2,'sub_type': 0,'type': 6,'type_name': 'double precision'},
                {'alias': '','comment': '','expression': '"czyn_wyk"','length': 10,'name': 'czyn_wyk','precision': 0,'sub_type': 0,'type': 10,'type_name': 'text'},
